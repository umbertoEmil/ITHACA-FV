...
template<class TypeField>
double ITHACAutilities::relError_fields_LinfNorm(TypeField& field1,
        TypeField& field2)
{
    double err;
    ...
    {
        err = LinfNorm(field1 - field2) / LinfNorm(field1);
    }
...
double ITHACAutilities::L2normOnPatch(fvMesh& mesh, volScalarField& field,
                                      word patch)
{
    double L2 = 0;
...
double ITHACAutilities::LinfNormOnPatch(fvMesh& mesh, volScalarField& field,
                                        word patch)
{
    double Linf = 0;
    //Access the mesh information for the boundary
...
template double ITHACAutilities::relError_fields_LinfNorm(
...
>>>>>>> 75dec2ea... Created branch optimization
