...
#include "bayesianNumericalBenchmark.H"
...
int main(int argc, char* argv[])
{
    ...
    forAll(example.g, faceI)
    {
        ...
        example.g[faceI] = - example.k * (example.b * faceX + example.c * faceZ + example.d) ;
    }
    ...
    ITHACAstream::exportSolution(T, "1", "./ITHACAoutput/true/",
                                 "trueSol");
	...
	//unsigned int AdaptSteps = 1000;
        ...
        bayesianNumericalBenchmark bayesianExample(example, measurementsStdDev, regularizationParameter, TCrows, TCcols, pt); 
