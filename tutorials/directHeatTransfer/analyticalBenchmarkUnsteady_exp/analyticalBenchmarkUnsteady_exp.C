...
SourceFiles
    analyticalBenchmarkUnsteady_exp.C
\*---------------------------------------------------------------------------*/
...
#include "analyticalBenchmarkUnsteady_exp.H"
...
int main(int argc, char* argv[])
{
    ...
    analyticalBenchmarkUnsteady_exp example(argc, argv);
    ...
    double valueFraction =
        para->ITHACAdict->lookupOrDefault<double>("valueFraction",
                0.0);
    example.a = para->ITHACAdict->lookupOrDefault<double>("a", 0);
    example.b = para->ITHACAdict->lookupOrDefault<double>("b", 0);
    example.c = para->ITHACAdict->lookupOrDefault<double>("c", 0);
    example.d = para->ITHACAdict->lookupOrDefault<double>("d", 0);
