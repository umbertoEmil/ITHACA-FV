...
int main(int argc, char* argv[])
{
    ...
    if(userDefinedTemperatures)
    {
        ...
        {
            example_CG.Tmeas(cellI) = T.internalField()[example_CG.thermocouplesCellID[cellI]];
        }
    ...
    if(parameterizedBCtest)
    {
        ...
        if(userDefinedTemperatures)
        {
            example_paramBC.postProcess(outputFolder, "gParametrized", userDefinedTemperatures);
	}
	else
	{
	    example_paramBC.postProcess(outputFolder, "gParametrized", userDefinedTemperatures);
