...
SourceFiles
    analyticalBenchmark_totalHeatFlux.C
\*---------------------------------------------------------------------------*/
...
#include "analyticalBenchmark_totalHeatFlux.H"
...
int main(int argc, char* argv[])
{
    ...
    analyticalBenchmark_totalHeatFlux_paramBC example_paramBC(argc, argv);
    analyticalBenchmark_totalHeatFlux_CG example_CG(argc, argv);
    ...
    M_Assert(example_paramBC.thermocouplesNum > 0,
