...
REDprobeCenter_gRec = np.loadtxt( "./ITHACAoutput/testInverseReduced/probeCenter_gRec_mat.txt")
REDprobeCenter_Trec = np.loadtxt( "./ITHACAoutput/testInverseReduced/probeCenter_Trec_mat.txt")
...
#REDavgRelErr_L2 = np.loadtxt("./ITHACAoutput/testInverseReduced/avgRelErrL2norm_mat.txt")
#REDavgRelErr_Linf = np.loadtxt("./ITHACAoutput/testInverseReduced/avgRelErrLinfNorm_mat.txt")
