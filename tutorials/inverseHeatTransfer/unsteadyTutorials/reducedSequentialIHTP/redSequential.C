...
int main(int argc, char* argv[])
{
    ...
    redSequential example(argc, argv);
    ...
    {
        example.sequentialIHTP::parameterizedBC(outputFolderFULL, initialField, linSysSolver, TSVDtruncation);
