...
int main(int argc, char* argv[])
{
    ...
    linearBasisTest_ROM example(argc, argv);
    ...
    if(FOMtest)
    {
        example.sequentialIHTP_linear::computeHeatFluxWeights(initialField, 
    ...
    if(ROMtest)
    {
        ...
        example.T_basis.resize(0);
        example.T_d.resize(0);
