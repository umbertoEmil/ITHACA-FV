...
plt.legend(handles=h, labels=[r"$||e_{rel}||_{L^2(\Gamma_{s_{in}})}$", r"$||e_{rel}||_{L^\infty(\Gamma_{s_{in}})}$"], ncol = 2, bbox_to_anchor=(0., 1.1), frameon=False, edgecolor = ('k'), loc="upper left" , borderaxespad=0.)
