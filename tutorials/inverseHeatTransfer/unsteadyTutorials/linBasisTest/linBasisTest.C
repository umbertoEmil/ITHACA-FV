...
int main(int argc, char* argv[])
{
    ...
    linBasisTest example(argc, argv);
    ...
    unsigned parameterizedBC_unsteadyTestRED =
        para->ITHACAdict->lookupOrDefault<unsigned>("parameterizedBC_unsteadyTestRED", 0);
    ...
    {
        example.reconstructionTest(initialField, "./ITHACAoutput/reconstructionTest");
    }
    ...
    //// Reduced 
    //if(parameterizedBC_unsteadyTestRED)
    //{
