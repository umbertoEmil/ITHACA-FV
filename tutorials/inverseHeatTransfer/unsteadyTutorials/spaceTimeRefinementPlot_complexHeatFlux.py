...
folderLinear = "./linearBasisTest/resultsForPlots/complexHeatFlux/"
...
folderConstant = "./constantBasisTest/resultsForPlots/complexHeatFlux/"
...
plt.legend(handles=h, labels=["Piecewise constant", "Piecewise linear"], ncol = 2, bbox_to_anchor=(0., 1.056), frameon=False, edgecolor = ('k'), loc="upper left" , borderaxespad=0.)
...
plt.xlabel("Mesh size", fontsize=25)
plt.ylabel(r"max$_{t\in (0, t_f]}\left(||e_{rel}||_{L^2(\Gamma_{s_{in}})} \right)$", fontsize=25)
