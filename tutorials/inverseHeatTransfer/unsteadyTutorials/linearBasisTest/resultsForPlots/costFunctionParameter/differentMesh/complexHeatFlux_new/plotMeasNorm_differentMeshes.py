...
for fI in folders:
    ...
    axes[0].loglog(costFunctionParameter, measurementsDiscrepancy_mean,'-o', markersize = 6, linewidth = 2, label="Mesh" + str(mesh[i]))
    i = i + 1
...
for fI in folders:
    ...
    axes[1].loglog(costFunctionParameter, heatFluxL2norm_mean,'-o', markersize = 6, linewidth = 2, label="Mesh" + str(mesh[i]))
    i = i + 1
