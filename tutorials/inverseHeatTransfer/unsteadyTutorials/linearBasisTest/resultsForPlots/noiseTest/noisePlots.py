...
heatFluxRelErr_L2 = np.loadtxt(forderLU + "heatFluxRelErr_L2_list.txt")
...
plt.yscale('log')
plt.xscale('log')
plt.errorbar(noiseLevel, relErr_L2norm, yerr=[relErr_L2norm - relErr_L2normMin, relErr_L2normmean - relErr_L2norm], markersize=15,fmt='bo-', capsize=12, label = 'LU')
