...
relError_L2norm = np.loadtxt("coarseMesh/ITHACAoutput/ParamBCnoiseLevelTest_TSVD7/relError_L2norm_mat.txt")
relError_LinfNorm = np.loadtxt("coarseMesh/ITHACAoutput/ParamBCnoiseLevelTest_TSVD7/relError_LinfNorm_mat.txt")

noiseLevel = np.loadtxt("coarseMesh/ITHACAoutput/ParamBCnoiseLevelTest_TSVD7/noiseLevelVec_mat.txt")
