...
noiseLevel = np.loadtxt("coarseMesh/ITHACAoutput/ParamBCnoiseLevelTest/noiseLevelVec_mat.txt")
...
plt.errorbar(noiseLevel, relErr_LinfNorm, yerr=[relErr_LinfNorm - relErr_LinfNormMin, relErr_LinfNormMax - relErr_LinfNorm], markersize=15,fmt='kv', capsize=12, label = r'$||\epsilon||_{L^2(\Gamma_{s_{in}})}$')
