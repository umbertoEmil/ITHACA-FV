...
relError_L2norm = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_075/relError_L2norm_mat.txt")
relError_LinfNorm = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_075/relError_LinfNorm_mat.txt")
TSVDtruc = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_075/TSVDtrucVector_mat.txt")
...
plt.title(r'Noise standard dev. = $0.075$', fontsize=25)
plt.yscale('log')
