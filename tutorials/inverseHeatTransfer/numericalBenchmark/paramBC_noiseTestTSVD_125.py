...
relError_L2norm = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_125/relError_L2norm_mat.txt")
relError_LinfNorm = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_125/relError_LinfNorm_mat.txt")
TSVDtruc = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_125/TSVDtrucVector_mat.txt")
...
plt.title(r'Noise standard dev. = $0.125$', fontsize=25)
plt.yscale('log')
