...
shapePar = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCtest_RBFparameter/rbfShapeParameters_mat.txt")
...
for i in range(singVal.shape[1]):
    plt.semilogy(xAxis,singVal[:,i],'o', markersize=10, label=labels[i])
