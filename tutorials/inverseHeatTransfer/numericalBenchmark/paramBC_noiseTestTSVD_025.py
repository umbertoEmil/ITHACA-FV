...
relError_L2norm = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_025/relError_L2norm_mat.txt")
relError_LinfNorm = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_025/relError_LinfNorm_mat.txt")
TSVDtruc = np.loadtxt("coarseMesh/ITHACAoutput/parameterizedBCnoiseTest_TSVD_025/TSVDtrucVector_mat.txt")
...
plt.title(r'Noise standard dev. = $0.025$', fontsize=25)
plt.yscale('log')
