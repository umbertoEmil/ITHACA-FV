...
plt.plot(TSVDtruc, relErr_L2norm, 'bo', markersize=15, label = r'$||\epsilon||_{L^2(\Gamma_{s_{in}})}$')
plt.plot(TSVDtruc, relErr_LinfNorm, 'kv', markersize=15, label = r'$||\epsilon||_{L^\infty(\Gamma_{s_{in}})}$')
