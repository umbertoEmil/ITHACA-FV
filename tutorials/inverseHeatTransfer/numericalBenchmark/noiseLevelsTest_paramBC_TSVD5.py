...
relError_L2norm = np.loadtxt("coarseMesh/ITHACAoutput/ParamBCnoiseLevelTest_TSVD5/relError_L2norm_mat.txt")
relError_LinfNorm = np.loadtxt("coarseMesh/ITHACAoutput/ParamBCnoiseLevelTest_TSVD5/relError_LinfNorm_mat.txt")

noiseLevel = np.loadtxt("coarseMesh/ITHACAoutput/ParamBCnoiseLevelTest_TSVD5/noiseLevelVec_mat.txt")
...
plt.grid(True, which="both", ls="-")
plt.title(r"TSVD, $\alpha_{TSVD} = 5$", fontsize=25)
