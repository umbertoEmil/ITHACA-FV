...
relError_L2norm = np.loadtxt("coarseMesh/ITHACAoutput/thermocouplesNumberTest_paramBC/relError_L2norm_mat.txt")
relError_LinfNorm = np.loadtxt("coarseMesh/ITHACAoutput/thermocouplesNumberTest_paramBC/relError_LinfNorm_mat.txt")
TCplane_Y = np.loadtxt("coarseMesh/ITHACAoutput/thermocouplesNumberTest_paramBC/numberTCperAxis_mat.txt")
