...
relError_L2norm = np.loadtxt("coarseMesh/ITHACAoutput/thermocouplesLocationTest_CG/relError_L2norm_mat.txt")
relError_LinfNorm = np.loadtxt("coarseMesh/ITHACAoutput/thermocouplesLocationTest_CG/relError_LinfNorm_mat.txt")
TCplane_Y = np.loadtxt("coarseMesh/ITHACAoutput/thermocouplesLocationTest_CG/TCplane_Y_mat.txt")
